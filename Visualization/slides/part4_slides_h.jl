...
add_slide!(pres) do fig
    ...
    Label(fig[2, 1], "Basics: Multiple Axis", textsize = 60, tellwidth = false)
...
idx = [(19,25), (29, 60)]
srco = readlines("../part4_axis2.jl", keep=true)
hs = (200, 650)
for j in eachindex(idx)
    ...
    add_slide!(pres) do s
        ...
        axcode = Axis(fig1[1,1], height = hs[j], tellheight = false, 
...
#display(pres)
#MakieSlides.save(joinpath(@__DIR__, "part4_slides_h_dark.pdf"), pres)
MakieSlides.save(joinpath(@__DIR__, "part4_slides_h_light.pdf"), pres)
reset!(pres)