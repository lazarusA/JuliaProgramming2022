...
add_slide!(pres) do fig
    ...
    Label(fig[2, 1], "Basics: Axis3 & LScene", textsize = 60, tellwidth = false)
...
idx = [(10,14), (17, 30), (34, 45), (48, 76), (79, 81), (84,100), (103, 105)]
srco = readlines("../part5_axis3.jl", keep=true)
hs = (200, 650)
for j in eachindex(idx)
    ...
    add_slide!(pres) do s
        ...
        axcode = Axis(fig1[1,1], height = h1o, tellheight = false, 
...
#display(pres)
MakieSlides.save(joinpath(@__DIR__, "part5_slides_h_dark.pdf"), pres)
#MakieSlides.save(joinpath(@__DIR__, "part5_slides_h_light.pdf"), pres)
reset!(pres)